    ...
    <div className="sidebar d-flex flex-column justify-content-between border-end p-3 vh-100" style={{ width: "18rem" }}>
      <div>
        ...
        <ul className="nav nav-pills flex-column p-0 m-0">
          ...
          <li className="nav-item p-1">
            <Link to="/admin/dashboard/manage-groups" className="nav-link text-black">
              <i className="bi bi-gear me-2 fs-5"></i>
              <span className="fs-5">Manage Groups</span>
            </Link>
          </li>

          <li className="nav-item p-1">
            <Link to="/admin/dashboard/Projview" className="nav-link text-black">
              <i className="bi bi-card-list me-2 fs-5"></i>
              <span className="fs-5">View Projects</span>
            </Link>
          </li>

          <li className="nav-item p-1">
            <Link to="/admin/evaluationSettings" className="nav-link text-black">
              <i className="bi bi-gear me-2 fs-5"></i>
