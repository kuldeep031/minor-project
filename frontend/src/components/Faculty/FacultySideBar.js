    ...
    <div className="sidebar d-flex flex-column justify-content-between border-end p-3 vh-100" style={{ width: "18rem" }}>
      <div>
        ...
        <ul className="nav nav-pills flex-column p-0 m-0">
          ...
          <li className="nav-item p-1">
            <Link to="/faculty/projectinfo" className="nav-link text-black">
              <i className="bi bi-info-circle-fill me-2 fs-5"></i>
              <span className="fs-5">Projects Requests</span>
            </Link>
          </li>

          <li className="nav-item p-1">
            <Link to="/faculty/project-req" className="nav-link text-black">
              <i className="bi bi-info-circle-fill me-2 fs-5"></i>
              <span className="fs-5">Approved Projects</span>
            </Link>
          </li>

          {/* <li className="nav-item p-1">
            <Link to="/faculty/evaluationSettings" className="nav-link text-black">
              <i className="bi bi-gear me-2 fs-5"></i>
              <span className="fs-5">Evaluation Settings</span>
            </Link>
          </li> */}

          <li className="nav-item p-1">
            <Link to="/faculty/ProjectEvaluation" className="nav-link text-black">
              <i className="bi bi-clipboard-check me-2 fs-5"></i>
              <span className="fs-5">Project Evaluation</span>
            </Link>
          </li>
